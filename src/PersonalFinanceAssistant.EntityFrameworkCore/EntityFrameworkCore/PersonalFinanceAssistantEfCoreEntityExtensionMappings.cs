...
public static class PersonalFinanceAssistantEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE PersonalFinanceAssistantModuleExtensionConfigurator CLASS (in the Domain.Shared project)
